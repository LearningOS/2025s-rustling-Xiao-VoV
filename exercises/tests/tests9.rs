...
mod Foo {
    ...
    #[no_mangle] // Prevent symbol name mangling
    pub extern "Rust" fn my_demo_function(a: u32) -> u32 {
        a
    }

    #[no_mangle] // Prevent symbol name mangling
    #[link_name = "my_demo_function"] // Link this alias to `my_demo_function`
    pub extern "Rust" fn my_demo_function_alias(a: u32) -> u32 {
        a // This implementation is irrelevant since it's an alias
    }
}
